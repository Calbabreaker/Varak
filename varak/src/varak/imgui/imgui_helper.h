...
namespace Varak {
    ...
    namespace ImGuiHelper {
        ...
        bool drawInputText(std::string_view label, std::string& text, ImGuiInputTextFlags flags = 0);
        bool drawCheckbox(std::string_view label, bool& value);
        bool drawComboBegin(std::string_view label, std::string_view previewValue, ImGuiComboFlags flags = 0);
